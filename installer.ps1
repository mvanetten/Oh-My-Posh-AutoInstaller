...
Write-Host " Mr PowerShell says hi!"
...
Add-Content -Path $PROFILE -Value "# Generated By Mr PowerShell - Remove Lines to Unload - START #" 
...
if (Get-Module -Name Terminal-Icons){
    ...
    Write-Host " Terminal-Icons could not be downloaded." -ForegroundColor Red
}

Add-Content -Path $PROFILE -Value "# Generated By Mr PowerShell - END   #"
Clear-Host
Write-Host " ------- Final steps to take" -ForegroundColor Yellow
Write-Host " 1) Restart PowerShell Console" -ForegroundColor Yellow
Write-Host " 2) Right Click on PowerShell Titel Bar and select Properties." -ForegroundColor Yellow
Write-Host " 3) Select font Cousine NFM in Font Tab" -ForegroundColor Yellow